/* NewsBilingual 0.2.1 | Quantumult X | Generated by tools/build.cjs
...
function main() {
  ...
  try {
    ...
    if (typeof $response !== 'undefined') {
      ...
      if (body === null) log('response skipped path=' + route + ' method=' + $request.method + ' status=' + $response.statusCode + ' type=' + type);
