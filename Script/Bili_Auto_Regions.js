...
async function SwitchRegion(play) {
	...
	const TW = $.read('BiliArea_TW') || '结城明日奈'; //Your Taiwan sub-policy name.
	const HK = $.read('BiliArea_HK') || '亚丝娜'; //Your HongKong sub-policy name.
	const DF = $.read('BiliArea_DF') || '亚丝娜'; //Sub-policy name used after region is blocked(e.g. url 404)
